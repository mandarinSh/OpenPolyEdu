...
echo   4. Show activity type for all users (or for particular user) on course depending on the date.
echo   5. Calculate visits count for page(URL) distributed by day.
echo   6. Calculate total visits count for page(URL).
echo.
echo Utility analytics:
echo   7. Calculate unique user names.
echo   8. Calculate unique event names.
echo   9. Calculate unique user names and ids.
