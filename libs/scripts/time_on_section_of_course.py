...
def main(argv):
    ...
    print('Type course id to analyze activity')
    print('Start calculating users time on course.')

    # NOTE: database_name ? course_id
    database_name = argv[1]
    db_user = argv[2]
    result_file = argv[3]

    connection = open_db_connection(database_name, db_user)
